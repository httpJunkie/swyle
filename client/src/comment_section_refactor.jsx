        ...
        return (
                        ...
                        <div className="comments-section">
                            ...
                            {this.props.currentUser ?
                                ...
                                :
                    <span className="please-login-message">Please <Link className="please-login-button inverse" to="/login">Log In</Link> or <Link className="please-login-button" to="register">Sign Up</Link> to post comments</span>
                            }
